...
try {
    ...
    if ($tipo === 'cidade') {
        $sql = "SELECT DISTINCT cidade FROM Alunos WHERE LOWER(cidade) LIKE LOWER(:termo)";
    } elseif ($tipo === 'estado') {
        $sql = "SELECT DISTINCT estado FROM Alunos WHERE LOWER(estado) LIKE LOWER(:termo)";
    } elseif ($tipo === 'idioma') {
        $sql = "SELECT DISTINCT idioma FROM IdiomaAlunos WHERE LOWER(idioma) LIKE LOWER(:termo)";
    } else {
